...
CapCut, outside this workspace. It sits between [pre-edit prep](talk-1-pre-edit-prep.runbook.md)
and [post-edit processing](talk-3-post-edit-processing.runbook.md); see the
...
- `slides/slide-NN.png` — slide overlay frames from [pre-edit prep](talk-1-pre-edit-prep.runbook.md).
...
These are the contract into [post-edit processing](talk-3-post-edit-processing.runbook.md):
...
- [talk-3-post-edit-processing.runbook.md](talk-3-post-edit-processing.runbook.md) — the next phase.
