...
- **Phase 2 — [video edit](video-edit.runbook.md):** the editor drops the frames onto the CapCut timeline as slide overlays.
- **Phase 3 — [post-edit processing](post-edit-processing.runbook.md):** `/subtitle-polish` reads them as glossary/domain context when fixing mis-transcribed terms.
...
- [video-edit.runbook.md](video-edit.runbook.md) — the next phase.
