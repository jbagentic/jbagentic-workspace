...
- `<talk-slug>.en.raw.srt` — raw English subtitles from the [video edit](video-edit.runbook.md).
- `slides/slide-NN.png` — from [pre-edit prep](pre-edit-prep.runbook.md), used as glossary context.
