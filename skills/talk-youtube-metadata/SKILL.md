...
description: >-
  ...
  the file. Not for cleaning or polishing captions (use talk-caption-polish) or
  translating captions (use talk-caption-translate-zh).
---
...
- Community facts, canonical links, and ready-made blurbs: [`knowledge/jb-agentic-meetup.reference.md`](../../knowledge/jb-agentic-meetup.reference.md). This is the single source of truth for the series suffix, the Luma/YouTube links, and the short/long blurbs. Copy them verbatim — don't paraphrase.
...
1. **Digest the folder.** Run `scripts/srt_digest.py <folder>` (suggested) to parse the name into date / meetup # / speaker / topic and to get the cleaned transcript plus a bucketed timeline. If the name lacks `meetup-<N>`, ask before continuing.
...
## Related
- **Reference** — [jb-agentic-meetup](../../knowledge/jb-agentic-meetup.reference.md)
- **Reference** — [skill-convention](../../knowledge/skill-convention.reference.md)
- **How-to** — [talk-caption-polish](../talk-caption-polish/SKILL.md)
